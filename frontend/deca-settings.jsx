      ...
      try {
        ...
        if (settings && settings.profiles) {
          ...
          const apiGlass = (settings.glass || []).map(g => ({
            id: g.id, name: g.name, type: g.type, layers: g.layers, gasFill: g.gas_fill,
            lowE: g.low_e, uValue: +g.u_value, stc: g.stc, priceSqm: +g.price_sqm,
          }));
          ...
          const apiAccessories = (settings.accessories || []).map(a => ({
            id: a.id, name: a.name, type: a.type, price: +a.price, unit: a.unit, ...(a.specs || {}),
          }));
